        ...
        <div className="grid grid-cols-12 gap-8 p-6 md:p-10 lg:p-4 items-center">
          ...
          <div className="col-span-12 md:col-span-8 md:pl-4 lg:pl-8 self-center text-left">
            <div className="max-w-2xl mt-12">
              <h1 className={`text-3xl md:text-4xl leading-[1.1] ${dmSerif.className}`} style={{ color: GOLD }}>
                {recipe.Name.split(" ")[0]}
              </h1>
              <h2 className={`text-4xl md:text-5xl leading-[1.1] mb-4 md:mb-6 ${dmSerif.className}`} style={{ color: NAVY }}>
              ...
              <div style={{ color: NAVY }}>
                <p className={`${poppins.className} font text-base`}>
                  Bahan:
                </p>
                <div className="text-[13px] md:text-sm space-y-2 ">
                  {ingredientsList.map((ingredient, index) => (
                    <p
                      key={index}
                      className={`${poppins.className} mt-0 text-sm`}
                    >
                      {ingredient}
                    </p>
                  ))}
